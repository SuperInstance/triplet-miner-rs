...
impl Triplet {
    pub fn new(anchor: impl Into<String>, positive: impl Into<String>, negative: impl Into<String>) -> Self {
        Self { anchor: anchor.into(), positive: positive.into(), negative: negative.into(), similarity: 0.0, source: String::new(), metadata: HashMap::new() }
    }
    pub fn with_similarity(mut self, s: f64) -> Self { self.similarity = s; self }
    ...
    pub fn from_json(s: &str) -> Option<Self> { serde_json::from_str(s).ok() }
}
